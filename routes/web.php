...
Route::post('/ajaxuploadimg','FrontController@imguploadpost')->name('ajaxuploadimg');
Route::get('/project/{id}','FrontController@ProjectDetails')->name('project.view');

Route::post('/read-notification','FrontController@readNoti')->name('read.notify');
Route::get('/user-post-list/{u_id?}','FrontController@getUserpostList')->name('user.post.details');
/////////////////
Route::get('/generalpost-edit/{id}','FrontController@generalpostedit')->name('generalpost.edit');
Route::get('/projectpost-edit/{id}','FrontController@projectpostedit')->name('projectpost.edit');
Route::get('/grouppost-edit/{id}','FrontController@grouppostedit')->name('grouppost.edit');

Route::post('/generalpost-update/{id}','FrontController@generalpEdit')->name('generalpost.update');
Route::post('/projectpost-update/{id}','FrontController@projectpEdit')->name('projectpost.update');
Route::post('/grouppost-update/{id}','FrontController@grouppEdit')->name('grouppost.update');
//////////////////////////////////////////////////////////
Route::group(['prefix' => 'admin','middleware' => ['auth']], function() {
	Route::get('/fetch','NotificationController@fetchNotification')->name('admin.fetch.notification');
