...
.user_type_sec input[type="file"] {
    ...
    <span class="member-list" data-toggle="modal" data-target="#memberModal"><i class="fa fa-users"></i> &nbsp;Member List</span>
					<hr>
	...
	<div class="modal fade" id="memberModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<div class="row">
			@foreach($grprel as $pr)
			@php 
			$user_details=App\User::where('id',$pr->user_id)->first();
			@endphp
