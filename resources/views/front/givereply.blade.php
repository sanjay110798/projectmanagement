                  ...
                  <div class="comment d-flex mb-4">
                    ...
                    <div class="flex-grow-1 ms-2 ms-sm-3">
                      ...
                      <div class="comment-body">{{$comm->comment}}
                        @if($comm->img!='')
                         @php 
                         $file2=explode(",", $comm->img);
                         @endphp
                         @foreach($file2 as $key=>$val2)
                         <a href="{{$comm->img}}"> 
                          @php $ext = substr($val2, strrpos($val2, '.') + 1); @endphp
                          @if($ext == 'jpg' || $ext == 'JPG' || $ext == 'jpeg' || $ext == 'JPEG' || $ext == 'webp' || $ext == 'png' || $ext == 'PNG')
                          <img src="{{$val2}}" style="width: 53px;display: block;">
                          @else
                            ...
                            <div class="reply d-flex mb-4">
                              ...
                              <div class="flex-grow-1 ms-2 ms-sm-3">
                                ...
                                <div class="reply-body">
                                  ...
                                  @if($repl->img!='')
                                  @php 
                                  $file=explode(",", $repl->img);
                                  @endphp
                                  @foreach($file as $key=>$val)
                                  <a href="{{$repl->img}}">
                                    @php $ext = substr($val, strrpos($val, '.') + 1); @endphp
                                    @if($ext == 'jpg' || $ext == 'JPG' || $ext == 'jpeg' || $ext == 'JPEG' || $ext == 'webp' || $ext == 'png' || $ext == 'PNG')
                                    <img src="{{$val}}" style="width: 53px;display: block;">
                                    @else
                                    <i class="fas fa-file-alt" style="font-size: 66px;display: block;"></i>
                  ...
                  <form method="post" action="{{route('give.reply')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-9">
                        ...
                        <input type="file" name="img[]" multiple id="cimg_{{$comm->id}}" style="opacity:0;">
                      </div>
                      <div class="col-md-3">
