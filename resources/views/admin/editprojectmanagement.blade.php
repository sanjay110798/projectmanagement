               ...
               @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value="{{$project->project_name}}" placeholder="Enter Name" required>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <th scope="row">{{$i++}}</th>
                    <td>{{$pro->empl->name}}</td>
                    <td><a href="{{route('delete.projectRel',['id'=>$pro->id])}}" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                    </tr>
                    <?php
                    }
                    ?>
